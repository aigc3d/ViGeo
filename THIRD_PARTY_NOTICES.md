...
This notice summarizes license information for third-party code and baseline model components used by this repository. It is not legal advice.

## Components

| Component | Local code or usage | Code license / notes |
| --- | --- | --- |
| Depth Anything 3 [<a href="https://github.com/ByteDance-Seed/Depth-Anything-3">GitHub</a>] [<a href="https://huggingface.co/depth-anything/DA3-GIANT-1.1">HF</a>] | `depth_benchmarks/depth_anything_3` | Apache-2.0 |
| Video Depth Anything [<a href="https://github.com/DepthAnything/Video-Depth-Anything">GitHub</a>] | `depth_benchmarks/vda` | Apache-2.0 |
| FlashDepth [<a href="https://github.com/Eyeline-Labs/FlashDepth">GitHub</a>] [<a href="https://huggingface.co/Eyeline-Labs/FlashDepth">HF</a>] | `depth_benchmarks/flashdepth` | Apache-2.0 |
| Pi3 [<a href="https://github.com/yyfz/Pi3">GitHub</a>] [<a href="https://huggingface.co/yyfz233/Pi3">HF</a>] | `depth_benchmarks/pi3` | BSD-3-Clause |
...
| DepthCrafter [<a href="https://github.com/Tencent/DepthCrafter">GitHub</a>] [<a href="https://huggingface.co/spaces/tencent/DepthCrafter">HF</a>] | `depth_benchmarks/depthcrafter` | Tencent research-only license; uses Stable Video Diffusion components |
| DSINE [<a href="https://github.com/baegwangbin/DSINE">GitHub</a>] | `torch.hub.load("hugoycj/DSINE-hub", "DSINE", ...)` | Imperial College custom non-commercial research license |
