...
weight_cfg=dict(
    ckpt_path='logs/vigeo_stage1_224x224/tensorboard/version_0/checkpoints/last.ckpt',
    load_keys=['pretrained', 'decoder', 'point_head', 'camera_head', 'ray_head'],
    ignore_keys=None,
    freeze_keys=None,
    copy_mapping=None,
    load_target=None,
