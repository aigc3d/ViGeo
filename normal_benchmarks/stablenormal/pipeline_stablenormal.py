...
def _load_dinov2_backbone(model_name):
    from depth_benchmarks.moge.model.dinov2.hub import backbones

    return getattr(backbones, model_name)(pretrained=True)
...
class DINOv2_Encoder(torch.nn.Module):
    ...
    def __init__(
        ...
        self.model = _load_dinov2_backbone(model_name)
...
class StableNormalPipeline(StableDiffusionControlNetPipeline):
    ...
    def ensemble_normals(
        ...
        mean_normals = StableNormalPipeline.normalize_normals(mean_normals)  # [1,3,H,W]
